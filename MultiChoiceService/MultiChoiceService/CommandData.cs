...
namespace MultiChoiceService
{
    public class CommandData
    {
        ...
        public const char UPDATEGAMETABLE = 'H';///< For changing the users game status to NOT running (isRunning = false)
        ...
        /* LeaderBoardTable */  /// Note: LeaderBoardTable has gameID 
